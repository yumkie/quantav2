    ...
    <main>
        <div class="friend_container">
            ...
            <div class="result_container">
                    ...
                    session_start();
                    $id = $_SESSION['id'];
                    $select = "SELECT * FROM Friends JOIN Users ON Friends.User_id = '$id' OR Friends.User_id2 = '$id'";
                ...
                <nav class="sent">
                    ...
                    <a><img src="../img/cancel.svg" height="50"></a>
                </nav>
                <nav class="friendship">
                    ...
                    <a><img src="../img/cancel.svg" height="50"></a>
                    <a><img src="../img/add.svg" height="50"></a>
                </nav>
                <nav class="find">
